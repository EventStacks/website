...
function rssFeed(type, title, desc, outputPath) {
  const posts = getAllPosts().sort((i1, i2) => {
  ...
  const base = 'https://eventstack.tech';
  ...
  // rss.channel.webMaster = 'info@asyncapi.io (AsyncAPI Initiative)' //Do we need this?
...
rssFeed('blog', 'EventStack Blog RSS Feed', 'EventStack Blog', 'rss.xml');
